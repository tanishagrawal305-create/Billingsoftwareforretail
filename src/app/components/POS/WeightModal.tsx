        ...
        <div className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <select
                ...
                className="px-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-indigo-500 font-medium"
              >
            ...
            <div className="grid grid-cols-5 gap-2">
              {quickWeights.map((qty) => (
                <button
                  ...
                  className="py-2 px-3 rounded-lg bg-indigo-50 text-indigo-600 hover:bg-indigo-100 transition-colors font-medium text-sm"
                >
                  {qty}
          ...
          <div className="flex gap-3">
            ...
            <button
              ...
              className="flex-1 bg-indigo-600 text-white px-6 py-3 rounded-lg hover:bg-indigo-700 transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed font-medium"
            >
              Add to Cart
            </button>
          </div>
